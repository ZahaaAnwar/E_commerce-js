...
document.getElementById('addproduct').addEventListener('click',(e) =>{
    ...
    let price1 = document.getElementById("price").value.trim()
    let description1 = document.getElementById("description").value.trim()
    if(title1==="" || price1==="" || description1===""){
        alert("Plz fill the credentials!")
        return
    }

    let newProduct = {
        id:arrayNewProducts.length+1,
        title : title1,
        price : price1,
